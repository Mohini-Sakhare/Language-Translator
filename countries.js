const countries = {
  ...
  'zh-CN': { language: 'Chinese', country: 'China (Simplified)' },
  'zh-TW': { language: 'Chinese', country: 'Taiwan (Traditional)' },
  ...
  'bn-BD': { language: 'Bengali', country: 'Bangladesh' },
  ...
  // ... and so on for all countries and languages
};